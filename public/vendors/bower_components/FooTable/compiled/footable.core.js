...
(function($, F){
	 ...
	 * that works across a multitude of browsers. With a combination of versatility and extensibility, jQuery has changed the way that millions of item write JavaScript.
	 * @name jQuery
	 * @constructor
	 * @returns {jQuery}
