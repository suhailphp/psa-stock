...
router.get('/add', async (req,res)=>{
    ...
    res.render('issue/add',{curPage,departments,staffs,data});
});

router.get('/edit/:issueID', async (req,res)=>{
   ...
   let departments = await departmentModel.findAll();
   let staffs = await staffModel.findAll();
   res.render('issue/add',{curPage,data,departments,staffs,issueItems,editData:true});
});
