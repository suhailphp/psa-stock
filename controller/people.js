...
router.get('/', async (req,res)=>{
    ...
    res.render('item/list',{data:users});
});
...
router.get('/edit/:id' ,async (req,res)=>{
    ...
    res.render('item/add',{data:data,trans:trans,editData:true,date:date});
});
...
router.post('/', async (req,res)=>{
    ...
    if(req.body.action == 'edit'){
        ...
        if (error){
            ...
            return res.redirect('/item/edit/'+req.body.id);
        }
